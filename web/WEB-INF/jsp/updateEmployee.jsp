...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="content">
                <spring:form  action="/AdminKMA/saveUpdateEmployee" method="post"  modelAttribute="e" >
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <spring:input type="text" path="idRFID" disabled="true" value="" class="form-control" id="exampleFormControlInput1" placeholder="Nhập emali"/>
                        </div>
                        <div class="form-group col-6">
                            <label for="exampleFormControlInput1" class="TittleChildren">id Finterprint</label>
                            <spring:input type="text" path="idFingerprint" disabled="true" class="form-control" id="exampleFormControlInput1" placeholder="Nhập mật khẩu"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-6">
                        ...
                        <div class='col-6 form-group'>
                            <div id="filterDate2">
                                ...
                                <div class="input-group date" data-date-format="dd.mm.yyyy">
                                    ...
                                    <spring:input  type="text" path="birthday" class="form-control" placeholder="dd-mm-yyyy"/>
