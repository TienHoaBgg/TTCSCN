...
//Tháng Hiện Tại trừ 1
    ...
    public String monthNow() {
        ...
        int monthInt = Integer.parseInt(nowMonth) - 1;
        SimpleDateFormat dateFormatYear = new SimpleDateFormat("yyyy");
        String nowYear = dateFormatYear.format(date);

        return String.valueOf(monthInt) + "-" + nowYear;
...
// Tính Phần Trăm 
    ...
    public List<Statistical> ListDayOnLateTimeEmployeeR(int idRoom, String dateStart, String dateEnd, List<String> lIdRFID) throws SQLException, ParseException {
        int totalDay = CountAboutDay(dateStart, dateEnd);
        List<Statistical> ls = new ArrayList<>();
        for (String idRFID : lIdRFID) {
